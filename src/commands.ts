...
export const COMMANDS: readonly Command[] = [
  ...
  },
  {
    ...
    detail: [
      ...
      'vocabulary is refused under this flag. A tag applies when any passage',
      'reaches near-certainty (0.95) — calibrated 2026-08-30 against 249 real',
      'labelled documents, where peak score beat every corroboration-count rule.',
      'Per-tag evidence is printed to stderr. It exists for machines that',
      'cannot hold an LLM at all.',
      '',
      'WHAT IT NEEDS. An Ollama server at --ollama (default',
  ...
  },
  {
    ...
    detail: [
      ...
      '',
      '--model picks the translator. qwen3.8:27b is the default (Owen, 2026-08-22:',
      '27b is the standard for every task). qwen3:32b was the best of',
