...
const api: FoundryApi = {
  ...
  crucible: {
    ...
    beginRemotePairing: (address) => ipcRenderer.invoke('foundry:crucible-pair-start', address),
    pollRemotePairing: (id) => ipcRenderer.invoke('foundry:crucible-pair-poll', id),
