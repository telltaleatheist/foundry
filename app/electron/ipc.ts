...
import { preSdkInstallDoor, runInstallNarrated } from './crucible-install-door';
import {
...
export function registerIpc(): void {
  ...
  /*
   * THE SEAM, BUILT ONCE (electron/crucible-install-door.ts). Part 2 of PHASE19
   * replaces this one expression with the SDK's `installStatus()`/
   * `watchInstall()` door and nothing else in this file moves.
   */
  const installDoor = preSdkInstallDoor();
