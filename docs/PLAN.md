...
### Wave 19 — the env install refuses a folder WSL cannot see (found from bookforge-pc-2's report, 2026-08-19) — LANDED (this commit)
...
through `\wsl# The plan of record — everything left, and who it is waiting on
...
, which is right for a session-state file of a few
